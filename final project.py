...
# 🚩 Project Overview:
# This script analyzes global COVID-19 data focusing on cases, deaths, recoveries, and vaccinations across time and countries.
...
# Load dataset (Ensure the path uses the correct separator for your OS)
...
map_df = pd.read_csv("PLP_Covid19_Project/owid-covid-data.csv")
